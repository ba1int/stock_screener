...
def test_news_fetching_multiple_stocks():
    ...
    for ticker, news in news_data.items():
        status = "Success" if news and news != "No recent news found." else "No news found"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--single', action='store_true', help='Test with a single stock')
    parser.add_argument('--sample', action='store_true', help='Test with sample data (no API calls)')
