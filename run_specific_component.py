...
def run_stock_screening():
    ...
    logger.info(f"Running stock screening component with {len(sample_tickers)} sample tickers...")
...
def run_news_fetching():
    ...
    logger.info(f"Running news fetching component with {len(sample_tickers)} sample tickers...")
...
def run_ai_analysis():
    ...
    logger.info(f"Running AI analysis component with {len(sample_data)} sample stocks...")
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Run specific components of the stock screener")
    
    # Add arguments for each component
    parser.add_argument("--fetch", action="store_true", help="Run stock fetching component")
    parser.add_argument("--screen", action="store_true", help="Run stock screening component")
    parser.add_argument("--news", action="store_true", help="Run news fetching component")
    parser.add_argument("--analyze", action="store_true", help="Run AI analysis component")
...
if __name__ == "__main__":
    ...
    if not (args.fetch or args.screen or args.news or args.analyze):
        logger.error("No components specified. Use --fetch, --screen, --news, or --analyze")
        sys.exit(1)
